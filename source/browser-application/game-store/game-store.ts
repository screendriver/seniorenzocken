...
// eslint-disable-next-line @typescript-eslint/explicit-function-return-type -- Pinia works with type inference
export function useGameStore(trpcClient: TRPCClient<TRPCApplicationRouter>) {
