...
describe("notPersistedTeam1Schema", () => {
	...
	it("fails parsing when teamNumber is undefined", () => {
	...
	it("fails parsing when teamNumber is null", () => {
	...
	it("fails parsing when teamNumber is not a number", () => {
	...
	it("fails parsing when teamNumber equals 0", () => {
	...
	it("fails parsing when teamNumber equals -1", () => {
	...
	it("fails parsing when teamNumber equals 3", () => {
	...
	it("fails parsing when name is undefined", () => {
	...
	it("fails parsing when name is null", () => {
	...
	it("fails parsing when name is not a string", () => {
	...
	it("fails parsing when name is an empty string", () => {
	...
	it("fails parsing when currentRoundGamePoints is undefined", () => {
	...
	it("fails parsing when currentRoundGamePoints is null", () => {
	...
	it("fails parsing when currentRoundGamePoints is not a number", () => {
	...
	it("fails parsing when currentRoundGamePoints equals -1", () => {
	...
	it("fails parsing when currentRoundGamePoints equals 5", () => {
	...
	it("fails parsing when matchTotalGamePoints is undefined", () => {
	...
	it("fails parsing when matchTotalGamePoints is null", () => {
	...
	it("fails parsing when matchTotalGamePoints is not a number", () => {
	...
	it("fails parsing when matchTotalGamePoints equals -1", () => {
	...
	it("fails parsing when matchTotalGamePoints equals 19", () => {
	...
	it("fails parsing when isStretched is undefined", () => {
	...
	it("fails parsing when isStretched is null", () => {
	...
	it("fails parsing when isStretched is not a boolean", () => {
	...
	it("succeeds parsing when teamNumber equals $teamNumber", () => {
	...
	it("succeeds parsing when name is not an empty string", () => {
	...
	])("succeeds parsing when currentRoundGamePoints equals $currentRoundGamePoints", ({ currentRoundGamePoints }) => {
	...
	])("succeeds parsing when matchTotalGamePoints equals $matchTotalGamePoints", ({ matchTotalGamePoints }) => {
	...
	it.each([{ isStretched: true }, { isStretched: false }])(
		"succeeds parsing when isStretched equals $isStretched",
		({ isStretched }) => {
...
describe("notPersistedTeam2Schema", () => {
	it("fails parsing when given data is undefined", () => {
	...
	it("succeeds parsing when teamNumber equals 2", () => {
