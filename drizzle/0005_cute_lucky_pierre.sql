...
INSERT INTO `__new_game_point_audios`("game_point_audio_id", "name", "game_points", "audio_file") SELECT "game_point_audio_id", "name", "game_points", "file_name" FROM `game_point_audios`;--> statement-breakpoint
